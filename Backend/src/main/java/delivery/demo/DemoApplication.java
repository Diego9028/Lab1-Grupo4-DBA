...
/*
2025-05-07T18:46:32.254-04:00  WARN 17796 --- [demo] [nio-8090-exec-1] o.h.engine.jdbc.spi.SqlExceptionHelper   : SQL Error: 0, SQLState: 23505
2025-05-07T18:46:32.254-04:00 ERROR 17796 --- [demo] [nio-8090-exec-1] o.h.engine.jdbc.spi.SqlExceptionHelper   : ERROR: llave duplicada viola restricción de unicidad «uk8duxx4vm6d736wokeq3u5skw7»
  Detail: Ya existe la llave (correo)=(b@gmail.com).
2025-05-07T18:46:32.271-04:00 ERROR 17796 --- [demo] [nio-8090-exec-1] o.a.c.c.C.[.[.[/].[dispatcherServlet]    : Servlet.service() for servlet [dispatcherServlet] in context with path [] threw exception [Request processing failed: org.springframework.dao.DataIntegrityViolationException: could not execute statement [ERROR: llave duplicada viola restricción de unicidad «uk8duxx4vm6d736wokeq3u5skw7»
  Detail: Ya existe la llave (correo)=(b@gmail.com).] [insert into clientes (correo,direccion,nombre,password) values (?,?,?,?)]; SQL [insert into clientes (correo,direccion,nombre,password) values (?,?,?,?)]; constraint [null]] with root cause

org.postgresql.util.PSQLException: ERROR: llave duplicada viola restricción de unicidad «uk8duxx4vm6d736wokeq3u5skw7»
  Detail: Ya existe la llave (correo)=(b@gmail.com).
	...
	at delivery.demo.services.TokenSevice.register(TokenSevice.java:36) ~[classes/:na]
	at delivery.demo.controllers.TokenController.registrarCliente(TokenController.java:21) ~[classes/:na]
	at java.base/jdk.internal.reflect.NativeMethodAccessorImpl.invoke0(Native Method) ~[na:na]
	at java.base/jdk.internal.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:77) ~[na:na]
	at java.base/jdk.internal.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:43) ~[na:na]
	at java.base/java.lang.reflect.Method.invoke(Method.java:569) ~[na:na]
	...
	at org.springframework.security.web.FilterChainProxy$VirtualFilterChain.doFilter(FilterChainProxy.java:374) ~[spring-security-web-6.4.4.jar:6.4.4]
	at delivery.demo.config.JwtAuthFilter.doFilterInternal(JwtAuthFilter.java:45) ~[classes/:na]
